...
public class GoogleAuthenticatorUtil {
	...
	/**
	 * 时间前后偏移量 用于防止客户端时间不精确导致生成的TOTP与服务器端的TOTP一直不一致 如果为0,当前时间为 10:10:15 则表明在
	 * 10:10:00-10:10:30 之间生成的TOTP 能校验通过 如果为1,则表明在 10:09:30-10:10:00
	 * 10:10:00-10:10:30 10:10:30-10:11:00 之间生成的TOTP 能校验通过 以此类推
	 */
