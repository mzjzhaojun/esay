...
/**
 * @author sungang
 * @date 2021/10/15 1:58 下午 AES加、解密算法工具类 对称加密
 */
public class AesUtil {
	...
	/**
	 * key的长度，Wrong key size: must be equal to 128, 192 or 256 传入时需要16、24、36
	 */
	...
	/**
	 * 不能在代码中创建 JceSecurity.getVerificationResult 会将其put进 private static final
	 * Map<Provider,Object>中，导致内存缓便被耗尽
	 */
