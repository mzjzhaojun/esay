...
public class TronGetAddressThread2 implements Runnable {

	public TronGetAddressThread2() {
	}
		...
		while (true) {
			...
			if (liststringcode != null) {
				...
				if (listaddress != null) {
					...
					String startchar = address.substring(address.length() - 6, address.length() - 1);
