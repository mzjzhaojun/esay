 ...
 *
 * <p>
 * Can also be used in Spring MVC, as the return value from a @Controller
 * method:
 * 
 * <pre class="code">
 ...
 * @see #getStatusCode()
 */
public class YtResponseEntity<T> extends YtHttpEntity<T> {
	 ...
	 */
	public YtResponseEntity(HttpStatus statusCode) {
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEntity(T body, HttpStatus statusCode) {
		super(body);
		this.statusCode = statusCode;
	}
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEntity(MultiValueMap<String, String> headers, HttpStatus statusCode) {
		super(headers);
		this.statusCode = statusCode;
	}
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEntity(T body, MultiValueMap<String, String> headers, HttpStatus statusCode) {
		super(body, headers);
		this.statusCode = statusCode;
	}

	public YtResponseEntity(T body) {
		super(body);
		this.statusCode = HttpStatus.OK;
	}

	public YtResponseEntity(T body, MultiValueMap<String, String> headers) {
		super(body, headers);
		this.statusCode = HttpStatus.OK;
	}
	...
	public boolean equals(Object other) {
		...
		YtResponseEntity<?> otherEntity = (YtResponseEntity<?>) other;
	 ...
	 * @since 4.1
	 */
	public static <T> YtResponseEntity<T> ok(T body) {
	...
	public interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
		 ...
		 */
		<T> YtResponseEntity<T> body(T body);
	}
	...
	private static class DefaultBuilder implements BodyBuilder {
		...
		@Override
		public YtResponseEntity<Void> build() {
			return new YtResponseEntity<Void>(null, this.headers, this.status);
		}

		@Override
		public <T> YtResponseEntity<T> body(T body) {
			return new YtResponseEntity<T>(body, this.headers, this.status);
		}
	}
