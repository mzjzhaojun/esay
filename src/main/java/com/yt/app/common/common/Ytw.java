 ...
 * handler should be configured ahead of handlers that support any return value
 * type annotated with {@code @ModelAttribute} or {@code @ResponseBody} to
 * ensure they don't take over.
 *
 ...
 * @since 3.1
 */
public class Ytw extends AbstractMessageConverterMethodProcessor {
	 ...
	 */
	public Ytw(List<HttpMessageConverter<?>> converters) {
		super(converters);
	}
	 ...
	 */
	public Ytw(List<HttpMessageConverter<?>> converters, ContentNegotiationManager manager) {
	 ...
	 * @since 4.2
	 */
	public Ytw(List<HttpMessageConverter<?>> converters, List<Object> requestResponseBodyAdvice) {
	 ...
	 * {@code ResponseEntity}.
	 */
	public Ytw(List<HttpMessageConverter<?>> converters, @Nullable ContentNegotiationManager manager,
	...
	public Object resolveArgument(MethodParameter parameter, @Nullable ModelAndViewContainer mavContainer,
		...
		if (YtRequestEntity.class == parameter.getParameterType()) {
			return new YtRequestEntity<>(body, inputMessage.getHeaders(), inputMessage.getMethod(),
					inputMessage.getURI());
		} else {
	...
	private Type getHttpEntityType(MethodParameter parameter) {
		Assert.isAssignable(YtRequestEntity.class, parameter.getParameterType());
	...
	public void handleReturnValue(@Nullable Object returnValue, MethodParameter returnType,
		...
		if (responseEntity instanceof YtResponseEntity) {
			int returnStatus = ((YtResponseEntity<?>) responseEntity).getStatusCode().value();
