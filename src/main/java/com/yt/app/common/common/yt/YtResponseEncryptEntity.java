...
/**
 * Extension of {@link YtHttpEntity} that adds a {@link HttpStatus} status code.
 ...
 * @see #getStatusCode()
 */
public class YtResponseEncryptEntity<T> extends YtHttpEntity<T> {
	 ...
	 */
	public YtResponseEncryptEntity(HttpStatus statusCode) {
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEncryptEntity(T body, HttpStatus statusCode) {
		super(body);
		this.statusCode = statusCode;
	}
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEncryptEntity(MultiValueMap<String, String> headers, HttpStatus statusCode) {
		super(headers);
		this.statusCode = statusCode;
	}
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEncryptEntity(T body, MultiValueMap<String, String> headers, HttpStatus statusCode) {
		super(body, headers);
		this.statusCode = statusCode;
	}
	 ...
	 * @param statusCode the status code
	 */
	public YtResponseEncryptEntity(T body, MultiValueMap<String, String> headers) {
		super(body, headers);
		this.statusCode = HttpStatus.OK;
	}

	public YtResponseEncryptEntity(T body) {
		super(body);
		this.statusCode = HttpStatus.OK;
	}
	...
	public boolean equals(Object other) {
		...
		YtResponseEncryptEntity<?> otherEntity = (YtResponseEncryptEntity<?>) other;
	 ...
	 * @since 4.1
	 */
	public static <T> YtResponseEncryptEntity<T> ok(T body) {
	...
	public interface HeadersBuilder<B extends HeadersBuilder<B>> {
		 ...
		 */
		YtResponseEncryptEntity<Void> build();
	}
	...
	public interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
		 ...
		 */
		<T> YtResponseEncryptEntity<T> body(T body);
	}
	...
	private static class DefaultBuilder implements BodyBuilder {
		...
		@Override
		public YtResponseEncryptEntity<Void> build() {
			return new YtResponseEncryptEntity<Void>(null, this.headers, this.status);
		}

		@Override
		public <T> YtResponseEncryptEntity<T> body(T body) {
			return new YtResponseEncryptEntity<T>(body, this.headers, this.status);
		}
	}
