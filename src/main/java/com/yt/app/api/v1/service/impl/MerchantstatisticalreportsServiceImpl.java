...
@Service
public class MerchantstatisticalreportsServiceImpl extends YtBaseServiceImpl<Merchantstatisticalreports, Long> implements MerchantstatisticalreportsService {
	@Autowired
