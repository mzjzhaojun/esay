...
@Service
public class IncomemerchantaccountrecordServiceImpl extends YtBaseServiceImpl<Incomemerchantaccountrecord, Long> implements IncomemerchantaccountrecordService {
	@Autowired
