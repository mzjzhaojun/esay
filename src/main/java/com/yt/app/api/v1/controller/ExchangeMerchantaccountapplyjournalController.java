...
@RestController
@RequestMapping("/rest/v1/exchangemerchantaccountapplyjournal")
public class ExchangeMerchantaccountapplyjournalController
		extends YtBaseEncipherControllerImpl<ExchangeMerchantaccountapplyjournal, Long> {

	@Autowired
	private ExchangeMerchantaccountapplyjournalService service;
	...
	public YtResponseEncryptEntity<Object> list(YtRequestDecryptEntity<Object> requestEntity,
		...
		YtIPage<ExchangeMerchantaccountapplyjournal> pagebean = service
