...
@Getter
@Setter
public class ExchangeMerchantaccount extends YtBaseEntity<ExchangeMerchantaccount> {
	...
	public ExchangeMerchantaccount() {
	}

	public ExchangeMerchantaccount(Long id, Long tenant_id, Long merchantid, Double totalincome, Double withdrawamount,
