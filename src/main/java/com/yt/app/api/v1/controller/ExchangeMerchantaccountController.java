...
@RestController
@RequestMapping("/rest/v1/exchangemerchantaccount")
public class ExchangeMerchantaccountController extends YtBaseEncipherControllerImpl<ExchangeMerchantaccount, Long> {

	@Autowired
	private ExchangeMerchantaccountService service;

	@Override
	@RequestMapping(value = "/page", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public YtResponseEncryptEntity<Object> page(YtRequestDecryptEntity<Object> requestEntity, HttpServletRequest request, HttpServletResponse response) {
		YtIPage<ExchangeMerchantaccount> pagebean = service.page(RequestUtil.requestDecryptEntityToParamMap(requestEntity));
	...
	public YtResponseEncryptEntity<Object> data(HttpServletRequest request, HttpServletResponse response) {
		ExchangeMerchantaccount t = service.getData();
	...
	public YtResponseEncryptEntity<Object> bank(HttpServletRequest request, HttpServletResponse response) {
		ExchangeMerchantaccount t = service.getDataBank();
		return new YtResponseEncryptEntity<Object>(new YtBody(t));
	}
