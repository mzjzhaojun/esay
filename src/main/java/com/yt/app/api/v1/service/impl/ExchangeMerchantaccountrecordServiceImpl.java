...
@Service
public class ExchangeMerchantaccountrecordServiceImpl extends YtBaseServiceImpl<ExchangeMerchantaccountrecord, Long> implements ExchangeMerchantaccountrecordService {
	@Autowired
